...
def find_afterparties():
    ...
    payload = {'apikey': API_KEY,                             # - Use form data from the user to populate any search parameters
               'keyword': keyword,
    ...
    data = response.json()                                    # - Make sure to save the JSON data from the response to the `data`
    ...
    events = data.get('_embedded', {}).get('data', [])
